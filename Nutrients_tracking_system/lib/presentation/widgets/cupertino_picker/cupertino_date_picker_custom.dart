...
class CupertinoDatePickerCustom extends StatefulWidget {
  ...
  ///
  /// [dateOrder] determines the order of the columns inside [CupertinoDatePickerCustom]
  ...
  })  : initialDateTime = initialDateTime ?? clock.now(),
        assert(
          itemExtent > 0,
  ...
  /// Determines the order of the columns inside [CupertinoDatePickerCustom] in
...
class _CupertinoDatePickerDateTimeState
    extends State<CupertinoDatePickerCustom> {
  ...
  @override
  void didUpdateWidget(CupertinoDatePickerCustom oldWidget) {
...
class _CupertinoDatePickerDateState extends State<CupertinoDatePickerCustom> {
  ...
  void _refreshEstimatedColumnWidths() {
    estimatedColumnWidths[_PickerColumnType.dayOfMonth.index] =
        CupertinoDatePickerCustom._getColumnWidth(_PickerColumnType.dayOfMonth,
            localizations, context, widget.showDayOfWeek);
    estimatedColumnWidths[_PickerColumnType.month.index] =
        CupertinoDatePickerCustom._getColumnWidth(_PickerColumnType.month,
            localizations, context, widget.showDayOfWeek);
    estimatedColumnWidths[_PickerColumnType.year.index] =
        CupertinoDatePickerCustom._getColumnWidth(_PickerColumnType.year,
            localizations, context, widget.showDayOfWeek);
  }
    ...
    return Container(
      ...
      child: Container(
        ...
        decoration: const BoxDecoration(
          // The color is derived from iOS's native picker.
